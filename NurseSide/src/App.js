...
function App() {
  ...
  const calculateRiskScore = () => {
    ...
    if (formData.systolicBloodPressure >= 220) {
      ...
      formData.systolicBloodPressure >= 111 &&
      formData.systolicBloodPressure < 220
    ) {
      riskScore += 0;
    } else if (
      formData.systolicBloodPressure >= 101 &&
      formData.systolicBloodPressure < 111
    ) {
      riskScore += 1;
    } else if (
      formData.systolicBloodPressure >= 91 &&
      formData.systolicBloodPressure < 101
    ) {
      riskScore += 2;
    ...
    if (formData.oxygenSaturation >= 96) {
      ...
      formData.oxygenSaturation >= 94 &&
      formData.oxygenSaturation < 96
    ) {
      riskScore += 1;
    } else if (
      formData.oxygenSaturation >= 92 &&
      formData.oxygenSaturation < 93
    ) {
      riskScore += 2;
  ...
  const handleSubmit = (e) => {
    ...
    if (riskScore === 0) {
      ...
      monitoringInstructions =
        "Monitor every 6 hours by nurse. Needs nurse evaluation.";
    } else if (riskScore >= 5 && riskScore <= 6) {
      monitoringInstructions =
        "Doctor needs to review. Every 1-2 hours consult critical care response team.";
    } else if (riskScore >= 7) {
      monitoringInstructions =
        "Immediate on-site assessment by critical care response team.";
    }
